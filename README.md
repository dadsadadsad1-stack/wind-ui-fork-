...
WindUI accepts multiple icon sources in most places:

- Icon packs like `solar:home-2-bold`
- Roblox asset ids like `rbxassetid://1234567890`
- Direct image URLs

Section configs can also use `Desc` for a short subtitle below the title.
