...
local w=p.DefaultProperties[r]
if w then
for z,A in next,w do
x[z]=A
end
end
if u then
local loc=p.Localization
local locEnabled=loc and loc.Enabled
for B,C in next,u do
if B~="ThemeTag"then
x[B]=C
end
if locEnabled and B=="Text"then
local F=string.match(C,"^"..loc.Prefix.."(.+)")
if F then
...
aa.AddSignal(ar.Top.MouseEnter,function()
af(ar.Top,0.2,{BackgroundTransparency=0.96,BackgroundColor3=Color3.new(1,1,1)}):Play()
end)
aa.AddSignal(ar.Top.MouseLeave,function()
af(ar.Top,0.2,{BackgroundTransparency=1}):Play()
end)
BackgroundTransparency=1,
Size=UDim2.new(1,0,0,0),
AutomaticSize="Y",
...
af(an.ImageLabel,0.25,{Rotation=180},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end
end
...
af(an.ImageLabel,0.25,{Rotation=0},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end
end
...
PaddingLeft=UDim.new(0,ap.TabPaddingX+6),
PaddingRight=UDim.new(0,ap.TabPaddingX),
PaddingBottom=UDim.new(0,ap.TabPaddingY),
})
}),
},true)
ap.UIElements.SelectionIndicator=ap.UIElements.Main.Indicator
...
aj(aq.UIElements.Main,0.2,{ImageTransparency=1},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
aj(aq.UIElements.SelectionIndicator,0.2,{ImageTransparency=1,Size=UDim2.new(0,3,0,12)},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
aj(aq.UIElements.Main.Frame.TextLabel,0.2,{TextTransparency=0.45},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
if aq.UIElements.Icon and not aq.IconColor then
aj(aq.UIElements.Icon.ImageLabel,0.2,{ImageTransparency=0.5},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end
aq.Selected=false
end
end
aj(am.Tabs[ao].UIElements.Main,0.25,{ImageTransparency=0.92},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
aj(am.Tabs[ao].UIElements.SelectionIndicator,0.25,{ImageTransparency=0,Size=UDim2.new(0,3,0,18)},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
aj(am.Tabs[ao].UIElements.Main.Frame.TextLabel,0.25,{TextTransparency=0},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
if am.Tabs[ao].UIElements.Icon and not am.Tabs[ao].IconColor then
aj(am.Tabs[ao].UIElements.Icon.ImageLabel,0.25,{ImageTransparency=0},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end
...
aj(am.Containers[ao],0.3,{AnchorPoint=Vector2.new(0,0)},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end)
