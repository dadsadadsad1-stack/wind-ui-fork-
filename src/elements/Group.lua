...
function Element:New(Config)
    ...
    local GroupFrame = New("Frame", {
        ...
        New("UIListLayout", {
            ...
            Padding = UDim.new(0, Config.Tab and Config.Tab.Gap or Config.Window:GetSpacingValue())
        }),
    })
    ...
    ElementsModule.Load(
        ...
        function(CurrentElement, AllElements)
            local Gap = Config.Tab and Config.Tab.Gap or Config.Window:GetSpacingValue()
