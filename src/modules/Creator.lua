...
function Creator.IsAssetId(value)
	return typeof(value) == "string" and (
		value:match("^rbxassetid://")
		or value:match("^http://www%.roblox%.com/asset/%?id=")
		or value:match("^https://www%.roblox%.com/asset/%?id=")
	)
end
...
function Creator.Image(Img, Name, Corner, Folder, Type, IsThemeTag, Themed, ThemeTagName)
	...
	elseif typeof(Img) == "string" and string.find(Img, "http") and not string.find(Img, "roblox.com") then
	...
	elseif Creator.IsAssetId(Img) then
