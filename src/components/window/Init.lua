...
return function(Config)
	local Window = {
		...
		SpacingPreset = Config.SpacingPreset or "Normal",
		DragFrameSize = 160,
	...
	local SpacingValues = {
		Compact = 3,
		Normal = Window.NewElements and 1 or 6,
		Spacious = 10,
	}

	function Window:GetSpacingValue(preset)
		return SpacingValues[preset or Window.SpacingPreset] or SpacingValues.Normal
	end

	Window.Gap = Window:GetSpacingValue()
	...
	function Window:SetSpacingPreset(preset)
		Window.SpacingPreset = preset or "Normal"
		Window.Gap = Window:GetSpacingValue()
	end
